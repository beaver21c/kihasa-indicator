...
- **연도별 추이** (`/trend`): 19개 핵심 지표의 2018~2024 연도별 추이 비교
  - 모드 A 복수 지역 직접 비교(최대 5곳) / 모드 B 단일 지역 vs 비교집단(Q1~Q3 음영밴드)
  - 꺾은선·막대 전환, 지표별 Y축 자동 스케일, 그리드 + 카드 클릭 확대
  - 확대 모달에서 두 번째 지표 보조축(이중 Y축) 겹쳐보기 + 연도별 수치표
